...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,113);function _(f,S){const a=l("ExternalLinkIcon");return i(),c("div",null,[u,s("p",null,[n("Less 中文网址："),s("a",r,[n("Less 快速入门 | Less.js 中文文档 - Less 中文网 (bootcss.com)"),e(a)])]),d,v,k,m,s("ol",null,[s("li",null,[n("安装 node.js，可选择版本（8.0），网址："),s("a",b,[n("http://nodejs.cn/download/"),e(a)])]),h,g,x]),y])}const C=t(o,[["render",_],["__file","01.html.vue"]]);export{C as default};
